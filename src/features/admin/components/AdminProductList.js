...
import { fetchAllCategoriesAsync, fetchAllProductAsync, fetchAllProductByFilterAsync , fetchBrandsAsync, selectAllProducts, selectBrands, selectCategories, selectTotalItems } from "../../product-list/ProductSlice";
...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option)=>{
    ...
    //TODO: on server it will support multiple catogries
    if(e.target.checked){
...
{/* // Product here */}
                  ...
                  <div>
                    ...
                    className="text-sm my-5 mx-10 rounded-md bg-green-600 px-3 py-2 text-white font-semibold leading-6">
                      Add New Product
                    </Link>
                  </div>
                    {" "}
              ...
              {/* section for products and filter ends here */}
{/* //Pagination here */}
                <Pagination 
                page={page} 
                setPage={setPage} 
                          ...
                          {products.map((product) => (
                            ...
                            <Link key={product.id} to={`/productdetail/${product.id}`}>
                              <div  className="group relative p-2 border-solid border-gray-200 border-2 rounded-sm">
                                ...
                                <div className="mt-4 flex justify-between">
                                  ...
                                  <div>
                                      ...
                                      <p className="text-sm block mt-1 font-medium line-through text-gray-500">
                                        ${product.price}
                                      </p>
                                    </div>
                                  {product.deleted && <div>
                             ...
                             <div className="my-4">
                              ...
                              className="text-sm my-5 rounded-md bg-indigo-600 px-3 py-2 text-white font-semibold leading-6">
                                Edit Product
                                </Link>
                             </div>
                            </div>
