...
function CheckOut() {
  ...
  const totalAmout = items.reduce((amount, item) => discountedPrice(item)*item.quantity +amount, 0)
  ...
  const handleQuantity = (e, item) => {
    ...
    dispatch(updateCartAsync({...item, quantity:quantity}))
  }
  ...
  const handleOrder = (e) => {
    console.log(e)
    const order = {items, totalAmout, totalItems, user, paymentMethod, selectedAddress, status: 'pending'}
  ...
  return (
    <div>
          ...
          <div className="lg:col-span-3">
            <form className='bg-white px-5 mt-12' 
                  ...
                  onSubmit={handleSubmit((data) => {
                    console.log(data)
                    dispatch(updateUserAsync({...user, addressess:[...user.addresses,data]}))
                    reset();
                  })}>
      ...
      <h1 className="text-4xl mb-4 font-bold tracking-tight text-gray-900">Cart</h1>
